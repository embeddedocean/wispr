...
extern sd_mmc_err_t sd_card_write(uint8_t card_num, uint8_t *buffer, uint16_t nblocks);
extern sd_mmc_err_t sd_card_read(uint8_t card_num, uint8_t *buffer, uint16_t nblocks);
...
extern sd_mmc_err_t sd_card_write_header(sd_card_t *sd_card);
extern sd_mmc_err_t sd_card_read_header(sd_card_t *sd_card);

extern int sd_card_parse_header(uint8_t *buf, sd_card_t *hdr);
extern int sd_card_serialize_header(sd_card_t *hdr, uint8_t *buf);

extern sd_mmc_err_t sd_card_write_config(uint8_t card_num, wispr_config_t *hdr);
extern sd_mmc_err_t sd_card_read_config(uint8_t card_num, wispr_config_t *hdr);
